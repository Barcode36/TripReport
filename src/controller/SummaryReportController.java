...
public class SummaryReportController extends MainController {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        // AVERAGE
        double average30Kilometer = list30.stream().mapToInt(o -> o.getMilesDriven()).average().orElse(0);
        ...
        average30DaysKM.setText(d.format(total30Kilometer) + " km");
        average180DaysKM.setText(d.format(total180Kilometer) + " km");
        average1YearKM.setText(d.format(totalYearKilometer) + " km");
